...
public abstract class GameMap {
    ...
    public GameMap() {
        ...
        entities.add(new Player(800, 600, this, new Texture("player.png"), 500, 150, entities));
        entities.add(new Enemy(800, 600, this, new Texture("character.gif"), 10, 100, entities));
        entities.add(new Enemy(800, 550, this, new Texture("character.gif"), 10, 100, entities));
